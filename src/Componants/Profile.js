                                    ...
                                    <div className="album-list">
                                        {albums.map((album, index) => (
                                            <div className="album" key={album.id}>
                                                <img className="post_img view-comments-button" src={require(`../postimage/profile${id}/${index + 1}.jpg`)} alt="" onClick={() => openCommentsPopup(album.id)}/>
                                                <p>{album.title}</p>
                                                ...
                                                // onClick={() => openCommentsPopup(album.id)}
                                                >
                                                    <FaComment /> Comments
                                                </button>
                                            </div>
